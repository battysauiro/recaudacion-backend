...
public class OtrosProductosServicioImpl implements Servicios<OtrosProductosDTO> {
    ...
    public OtrosProductosDTO findById(String id) {
        ...
        OtrosProductosDTO otrosProductosDTO = new OtrosProductosDTO(otrosProductos.getIdContribucionProductos(), otrosProductos.getCantidad(), otrosProductos.getPeriodicidad().getIdPeriodicidad(), otrosProductos.getPeriodicidad().getNombrePeriodicidad(), otrosProductos.getIdOtrosProductos().getIdOtrosProductos(), otrosProductos.getIdOtrosProductos().getDescripcion(), otrosProductos.getContribucion().getCodigoContribucion(), otrosProductos.getContribucion().getConceptoContribucion(), otrosProductos.getContribucion().getIdTipoPago().getIdTipoPago(), otrosProductos.getContribucion().getIdTipoPago().getNombrePago(), otrosProductos.getContribucion().getIdDescripcion().getIdDescripcion(), otrosProductos.getContribucion().getIdDescripcion().getDescripcion());
