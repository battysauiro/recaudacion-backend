...
public class ImpuestoDTO extends ContribucionDTO{
    ...
    public ImpuestoDTO(String id_impuesto, int catalogo_impuesto,String scatalogo_impuesto, float cantidad, String codigo_contribucion, String concepto_contribucion, int id_tipo_pago, String tipo_pago, int id_descripcion, String descripcion) {
