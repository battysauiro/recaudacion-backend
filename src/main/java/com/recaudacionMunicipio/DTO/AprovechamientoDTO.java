...
public class AprovechamientoDTO extends ContribucionDTO{
    ...
    public AprovechamientoDTO(String id_contribucion, int id_catalogo,String scatalogo, String codigo_contribucion, String concepto_contribucion, int id_tipo_pago,String tipo_pago, int id_descripcion,String descripcion,int nivelContribucion,String nivelContribucionS) {
