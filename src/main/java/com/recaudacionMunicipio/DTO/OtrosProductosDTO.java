...
public class OtrosProductosDTO extends ContribucionDTO{
    ...
    public OtrosProductosDTO(String id_otros_productos, float cantidad, int periodicidad,String speriodicidad, int catalogo_otros_productos, String scatalogo_otros_productos,String codigo_contribucion, String concepto_contribucion, int id_tipo_pago,String tipo_pago, int id_descripcion, String descripcion) {
